...
const URL_CREATE_ELEMENT = "intern_api_fokus_bibli_keys_create";
const URL_UPDATE_ELEMENT = "intern_api_fokus_bibli_keys_update";

export function KeyFormulaire ({ context, element, pageId, identifiant }) {
