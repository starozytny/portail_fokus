...
Encore
    ...
    .addEntry('user_model', './assets/user/js/pages/model.js')
    .addEntry('user_bibli', './assets/user/js/pages/bibli.js')
    .addEntry('user_inventory', './assets/user/js/pages/inventory.js')
