...
class FokusApi
{
    ...
    {
        return $this->callApi("DELETE", "models/delete_model/" . $id);
    }
    ...
    {
        return $this->callApi("POST", "ai_comparator/" . $uidEntry . "/" . $uidOut, [], false);
    }

    public function aiComparatorContent($uidOut)
    {
